...
public class ChangeNow extends AppCompatActivity {
...
//        type=getIntent().getExtras().get("Admin").toString();
        ...
        recyclerView=(RecyclerView)findViewById(R.id.changerecycler);
...
//                Intent i=new Intent(ChangeNow.this,ScanItem.class);
                ...
                new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull Products model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                    Intent i=new Intent(ChangeNow.this,ChangeProductInfo.class);
